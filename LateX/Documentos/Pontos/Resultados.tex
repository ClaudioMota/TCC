...
\begin{figure}[H]
  ...
  {
    \includegraphics[height=5cm]{Base1/ResultadosSFM/nuvemConvencional}
    \label{figNuvemPontosA}
  }  
  \quad %espaco separador
  \subfloat[Obtida utilizando as imagens \textit{tonemapped} geradas.]
  {
    \includegraphics[height=5cm]{Base1/ResultadosSFM/nuvemToneMap}
    \label{figNuvemPontosB}
  }
  \quad %espaco separador
  \subfloat[Obtida utilizando as imagens \textit{tonemapped} com realce de contornos.]
  {
    \includegraphics[height=5cm]{Base1/ResultadosSFM/nuvemRealce}
...
\begin{figure}[H]
  ...
  \subfloat[Obtida utilizando imagens LDR convencionais.]
  {
    \includegraphics[height=5cm]{Base2/ResultadosSFM/nuvemConvencional}
    \label{figNuvemPontos2A}
  }  
  \quad %espaco separador
  \subfloat[Obtida utilizando as imagens \textit{tonemapped} geradas.]
  {
    \includegraphics[height=5cm]{Base2/ResultadosSFM/nuvemToneMap}
    \label{figNuvemPontos2B}
  }
  \quad %espaco separador
  \subfloat[Obtida utilizando as imagens \textit{tonemapped} com realce de contornos.]
  {
    \includegraphics[height=5cm]{Base2/ResultadosSFM/nuvemRealce}
