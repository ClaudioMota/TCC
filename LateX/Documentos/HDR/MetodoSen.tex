...
Dado um conjunto de $N$ imagens LDR $(L_1,L_2,..,L_N)$, onde uma destas é a imagem de referência $L_{ref}$ . Para que o problema possa ser trabalhado como minimização de energia as seguintes propriedades da imagem HDR $H$, que será inferida, devem ser satisfeitas:
...
\begin{figure}[H]
  ...
  {
    \includegraphics[height=6cm]{Sen/SalaLow}
    \label{figSenSalaA}
  }
  \quad %espaco separador
  \subfloat[Imagem visualizada com médio ganho]
  {
    \includegraphics[height=6cm]{Sen/SalaMedio}
    \label{figSenSalaB}
  }
  \quad %espaco separador
  \subfloat[Imagem visualizada com alto ganho]
  {
    \includegraphics[height=6cm]{Sen/SalaHigh}
    \label{figSenSalaC}
  }
...
\begin{figure}[H]
  ...
  \subfloat[Imagem visualizada com baixo ganho]
  {
    \includegraphics[height=6cm]{Sen/PorquinhoLow}
    \label{figSenPorquinhoA}
  }
  \quad %espaco separador
  \subfloat[Imagem visualizada com médio ganho]
  {
    \includegraphics[height=6cm]{Sen/Porquinho}
    \label{figSenPorquinhoB}
  }
  \quad %espaco separador
  \subfloat[Imagem visualizada com alto ganho]
  {
    \includegraphics[height=6cm]{Sen/PorquinhoHigh}
    \label{figSenPorquinhoC}
  }
  \caption{Imagem HDR gerada utilizando o método de Sen~\etal.}
