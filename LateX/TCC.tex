...
%%
\Titulo{GERAÇÃO DE NUVEM DE PONTOS A PARTIR DE IMAGENS HDR OBTIDAS PELO MÉTODO DE MÚLTIPLAS EXPOSIÇÕES} %\Titulo{Métodos de geração de imagens HDR}
...
\priAvaliador{Prof. Dr. Daniel Oliveira Dantas}
\UniverpriAvaliador{Universidade Federal de Sergipe (UFS)}
\segAvaliador{Prof. Dr. Leonardo Nogueira Matos}
...
Agradeço a meus amigos e família, especialmente a minha mãe, dona Jacy, e meu irmão, Willian. Obrigado por todo apoio, amor, dedicação e paciência. Sem vocês eu não teria conseguido.
...
\input{Documentos/ConceitosBasicos}

\input{Documentos/HDR/ParteHDR}
\input{Documentos/HDR/RevisaoBibliografica}
\input{Documentos/HDR/Metodos}
\input{Documentos/HDR/MetodosBaseImagens}
\input{Documentos/HDR/MetodoMann}
\input{Documentos/HDR/MetodoRobertson}
\input{Documentos/HDR/MetodoSen}
\input{Documentos/HDR/Discussoes}

\input{Documentos/Pontos/ObtencaoPontos}
\input{Documentos/Pontos/RevisaoBibliografica}
\input{Documentos/Pontos/SoftwaresUtilizados}
\input{Documentos/Pontos/ProcessoObtencaoNuvem}
\input{Documentos/Pontos/Proposta}
\input{Documentos/Pontos/BaseImagens}
\input{Documentos/Pontos/Resultados}

\input{Documentos/ConsideracoesFinais}
